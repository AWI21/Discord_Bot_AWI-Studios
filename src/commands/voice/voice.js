    ...
    async executeSlash(interaction) {
        ...
        switch (sub) {
            ...
            case 'claim':
                ...
                if (textChan) {
                    await textChan.permissionOverwrites.edit(member.id, { ViewChannel: true, SendMessages: true, ReadMessageHistory: true });
                }
            ...
            case 'ban': {
                ...
                if (textChan) {
                    await textChan.permissionOverwrites.edit(target.id, { ViewChannel: false });
                }
            ...
            case 'unban': {
                ...
                await voiceChan.permissionOverwrites.delete(target.id);
                if (textChan) {
                    await textChan.permissionOverwrites.delete(target.id);
                }
